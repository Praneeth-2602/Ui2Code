    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-6">
      ...
      <div className="space-y-8">
        ...
        <div className="relative w-fit mx-auto">
          ...
          <div className="relative rounded-[40px] overflow-hidden bg-white shadow-xl z-10 p-7 w-[640px] h-[340px]">
            <Image
            ...
            {/* Carousel Arrows */}
            <button className="absolute top-1/2 left-3 -translate-y-1/2 z-20 hover:scale-110 transition">
              <ChevronLeft className="h-12 w-8 text-black" />
            </button>
            <button className="absolute top-1/2 right-3 -translate-y-1/2 z-20 hover:scale-110 transition">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="relative h-[120px] w-full rounded-[24px] overflow-hidden bg-white shadow-sm">
              <Image
                src={imageSrc || "/placeholder.svg"}
                alt={`Thumbnail ${i}`}
                fill
